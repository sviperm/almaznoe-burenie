...
const items = [
    {
        ...
        text:
            'Выполнение работ по алмазному бурению технологических отверстий в кирпиче, бетоне, асфальте и дереве',
    },
    {
        icon: ruler,
        title: 'Любые размеры',
        text:
            'Технологические отверстия любых размеров, под все виды коммуникаций (вентиляция, сантехника, электричество и т.д.)',
    },
    {
        icon: cup,
...
export default () => (
    <Section id='main' fit>
        <BackgroundImage />
        <Title>Алмазное бурение в казани</Title>
        <Grid>
            {items.map((props, i) => (
